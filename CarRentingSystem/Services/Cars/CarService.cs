namespace CarRentingSystem.Services.Cars
{
    ...
    public class CarService : ICarService
    {
            ...
            int carsPerPage)
        {
            ...
            if (!string.IsNullOrEmpty(searchTherm))
            {
                carsQuery = carsQuery.Where(c =>
                  (c.Brand + " " + c.Model).ToLower().Contains(searchTherm.ToLower()) ||
                  c.Description.ToLower().Contains(searchTherm.ToLower()));
            }
        ...
        public IEnumerable<CarSeviceModel> ByUser(string userId)
            => GetCars(this.data
                .Cars
